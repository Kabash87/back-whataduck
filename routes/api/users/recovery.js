  ...
  try {
    ...
    if (findUser) {
      ...
      var mailOptions = {
        ...
        text: `¿Has olvidado tu contraseña en What a Duck? Por favor, ingresa al siguiente enlace para cambiar la contraseña de tu cuenta: http://localhost:3000/restore-password?token=${changePass}`,
