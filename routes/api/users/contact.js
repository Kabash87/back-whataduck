...
router.post("/", async (req, res) => {
  try {
    ...
    var mailOptions = {
      from:
        process.env.EMAIL_FROM || `"WhataDuck!" <${process.env.EMAIL_USER}>`,
      to: postemail,
      subject: `WhataDuck! 🦆¡ | ${senderName} esta muy interesad@ en comprarte ${postName}!`,
      html: `<h2>¡Hola ${postUsername}! Tenemos muy buenas noticias que pueden interesarte</h2>
             ...
             <p>Entra a WhataDuck! y revisa tu publicacion, ¡No pierdas esta oportunidad!</p>
             <a href="http://localhost:3000/"><button
              ...
              ">Entrar a WhataDuck!</button></a>
            <hr/><br/><br/>`,
    };

    console.log("Email destinatario:", postemail);
